...
export const StepsData = [
  ...
  // {
  //   id: 4,
  //   title: "Certified HSES Practices",
  //   description: [
  //     "Health, Safety, Environment, and Security (HSES) are critical to operational excellence in the oil and gas industry.",
  //     "At West Hova Integrated Solutions, we provide **certified HSES training programs** designed to meet global safety standards.",
  //     "Our training includes risk assessment, hazard identification, emergency response, and regulatory compliance.",
  //     "Participants who complete our training receive internationally recognized **HSES certification**, enhancing their career and industry credibility.",
  //     "We ensure our workforce and partners are equipped with the necessary skills to foster a safe and environmentally responsible work environment.",
  //     "Join our **Certified HSES Training** program today and take a proactive step toward workplace safety and compliance.",
  //   ],
  //   cta: "Get Certified",
  //   image: cert,
  //   bgColor: "#fff", // New image of people trained holding certificates
  // },
];
